...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movieList.add(new Movie(1, "Spiderman", "Es spiderman overview", 1f, new Date(), 18));
        movieList.add(new Movie(2, "Batman", "Es spiderman overview", 3f, new Date(), 17));
        movieList.add(new Movie(3, "Mango", "Es spiderman overview", 4.5f, new Date(), 16));
        movieList.add(new Movie(5, "R34", "Es spiderman overview", 4f, new Date(), 14));
...
/*        rowItems = new ArrayList<Cards>();
        ...
        arrayAdapter = new PhotoAdapter(this, R.layout.item, movieList);
