...
public class PhotoAdapter extends ArrayAdapter<Movie> {
    Context mContext;


    public PhotoAdapter(@NonNull Context context, int resource, @NonNull List<Movie> objects) {
        super(context, resource, objects);
        this.mContext = context;
    }

    public View getView(final int position, View convertView, ViewGroup parent) {
        final Movie movie_item = getItem(position);
...
/*        btnInfo.setOnClickListener(new View.OnClickListener() {
        ...
        name.setText(movie_item.getTitle());

        String url = "https://studiosol-a.akamaihd.net/uploadfile/letras/fotos/b/0/6/b/b06bbb414c627eb9d83f8194e6fae47b.jpg";
